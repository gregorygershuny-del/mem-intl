      ...
      <header className="sticky top-0 z-40 bg-white/80 backdrop-blur border-b border-neutral-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between">
          ...
          <div className="hidden md:block">
            <a href="#contact" className="inline-flex items-center rounded-2xl bg-neutral-900 text-white px-4 py-2 text-sm">Let’s Talk</a>
          </div>
        </div>
      </header>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24 grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <a href="#services" className="inline-flex items-center rounded-2xl bg-neutral-900 text-white px-5 py-2 text-sm">Explore Services</a>
          ...
          <div className="relative">
            <div className="rounded-3xl shadow-xl bg-white p-6 grid gap-4">
              ...
              <div className="rounded-2xl bg-neutral-900 text-white p-5">
                ...
                <p className="mt-1 text-lg font-medium">Price discovery, duty & premium math, and transparent settlement mechanics that mills and generators trust.</p>
              </div>
      ...
      <section id="about" className="py-16 lg:py-24 bg-neutral-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-10 items-start">
          <div>
            ...
            <p className="mt-3 text-neutral-700">Founded to bridge disciplined commodity trading with real-world yard and mill operations, MEM International Trading brings shop-floor accountability to market-facing decisions. We speak both languages: production and price. Our approach is forward and unvarnished—tight contracts, clear math, fast communication, and zero surprises.</p>
          ...
          <div className="rounded-3xl shadow-xl bg-white p-6">
            <div className="grid gap-4">
              ...
              <p className="text-xs text-neutral-500">Logistics partners, inspection firms, and secure destruction workflows available on request.</p>
            </div>
          </div>
        </div>
      </section>
